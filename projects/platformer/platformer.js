$(function () {
  ...
  function setup() {
    ...
    createPlatform(20, 450, 200, 25);// short but wide platform located 500 pixels from the left of the screen and 300 pixels from the top of the screen
    ...
    createCollectable("database",400, 100, 3)
    createCollectable("database",1150,300, 5)
    createCollectable("database",725,400, 5)
    ...
    createCannon("right", 900, 1000);// cannon on left wall, 600px down, shooting once per second
